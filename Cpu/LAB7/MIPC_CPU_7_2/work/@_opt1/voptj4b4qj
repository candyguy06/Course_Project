...
entity memory is
    ...
    attribute mti_svvh_generic_type of MemoryName : constant is 1;
    attribute mti_svvh_generic_type of MemSize : constant is 1;
    attribute mti_svvh_generic_type of MemAddrWidth : constant is 1;
    attribute mti_svvh_generic_type of InitFileName : constant is 1;
end memory;
